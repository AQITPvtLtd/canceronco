    ...
    <>
      ...
      >
        ...
        <div className="group relative transition-transform duration-500 hover:scale-125">
          <Link
            href="https://www.facebook.com/Canceronco5"
            role="button"
            target="_blank"
          >
        ...
        <div className="group relative w-max cursor-pointer transition-transform duration-500 hover:scale-125">
          <Link
            href="https://www.instagram.com/dr.sajjanrajpurohit/"
            role="button"
            target="_blank"
          >
        ...
        <div className="group relative w-max cursor-pointer transition-transform duration-500 hover:scale-125">
          <Link
            href="https://www.linkedin.com/company/canceronco"
            role="button"
            target="_blank"
          >
        ...
        <div className="group relative w-max cursor-pointer transition-transform duration-500 hover:scale-125">
          <Link
            href="https://www.youtube.com/channel/UCQZ2VTJX1TFL2-BbJpurz8Q"
            role="button"
            target="_blank"
          >
        ...
        <div className="group relative w-max transition-transform duration-500 hover:scale-125">
          <Link
            href="twitter.com/sajjan80"
            role="button"
            target="_blank"
          >
            <span className="[&>svg]:h-4 [&>svg]:w-4 text-black">
              <svg
        ...
        <div className="group relative w-max transition-transform duration-500 hover:scale-125">
          <Link
            href="https://in.pinterest.com/canceronco/"
            role="button"
            target="_blank"
          >
        ...
        <div className="group relative w-max transition-transform duration-500 hover:scale-125">
          <Link
            href="https://www.quora.com/profile/Dr-Sajjan-Rajpurohit-1?q=sajjan%20raj"
            role="button"
            target="_blank"
          >
            <svg
        ...
        {/* whatsapp */}
        <div className="group relative w-max transition-transform duration-500 hover:scale-125">
          <Link target="_blank" href="https://wa.me/919871280511" role="button">
      ...
      {!isOpen && (
        <button
          ...
          className="fixed top-1/2 right-0 transform -translate-y-1/2 
            bg-[#084cfc] pl-1 pt-1 pb-1 rounded-l-xl shadow-lg z-50 lg:hidden"
        >
          <Image src="/social/toggel.png" width={48} height={48} alt="" />
        </button>
      )}
    </>
  );
